 ...
 * Permitindo que sejam retornados resultados de funções que normalmente os bancos de dados já suportam, por exemplo:<br>
 * <li>count(id)</li>
 * <li>sum(total)</li> <br>
 * <br>
 * Sendo assim possível buscar contadores e valores sumarizados diretamente, ou mesmo os valores de apenas algumas colunas, ao invés de um objeto completamente montado.<br>
 * Normalmente esta classe é utilizada pelo RFW.ORM para obter dados do banco de dados, mas pode ser utilizado por qualquer estrutura de dados para indicar alguma manipulação.
 *
 * @author Rodrigo GML
...
public class RFWField implements Serializable, Cloneable {
   ...
   * Permite que o fornecedor dos dados consiga saber que o valor é um caminho de coluna (utilizando a estrutura do Match Objetc) para saber como conectar as tabelas.
   */
  final String field;
