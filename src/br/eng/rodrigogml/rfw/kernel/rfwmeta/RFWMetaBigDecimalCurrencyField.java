...
/**
 * Description: Annotation usada para definir um atributo do tipo BigDecimal usado para armazenar um valor monetário.<BR>
 *
...
public @interface RFWMetaBigDecimalCurrencyField {
  ...
  /**
   * Define o tamanho da escala/precisão que este BigDecimal deve ter.<br>
   * Por padrão esse valor é definido como 2 casas decimais e dificilmente precisará ser alterado para campos do tipo moeda.
   */
  int scale() default 2;
