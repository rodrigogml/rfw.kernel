...
/**
 * Description: Annotation usada para definir um atributo do tipo String que funcionará como um CNPJ.<BR>
 * O campo CNPJ será uma String apenas com os dígitos, sem nenhum tipo de formatação.
 *
...
public @interface RFWMetaStringCNPJField {
