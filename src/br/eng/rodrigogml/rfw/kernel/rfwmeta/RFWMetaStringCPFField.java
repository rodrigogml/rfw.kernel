...
/**
 * Description: Annotation usada para definir um atributo do tipo String que funcionará como um CPF.<BR>
 * O campo CPF será uma String apenas com os dígitos, sem nenhum tipo de formatação.
 *
...
public @interface RFWMetaStringCPFField {
